...
def get_params_pong():
    ...
    model = Sequential()
    model.add(Dense(16, input_dim=observation_space, activation='relu'))
    ...
    meta_model.add(Dense(16, input_dim=observation_space, activation='relu'))
    ...
    sub_model.add(Dense(16, input_dim=len(sub_spaces[0]), activation='relu'))
    ...
    sub_model2.add(Dense(16, input_dim=len(sub_spaces[1]), activation='relu'))
    sub_model2.add(Dense(16, activation='relu'))
    sub_model2.add(Dense(16, activation='relu'))
    sub_model2.add(Dense(16, activation='relu'))
    sub_model2.add(Dense(4, activation='relu'))
