...
class A2CAgent(BaseAgent):
    ...
    def replay(self):
        ...
        print(len(self.states), np.reshape(self.rewards, newshape=(-1, 1, 1)).shape, len(self.values[:-1]), np.reshape(self.actions_onehot, newshape=(-1, self.action_space)).shape)
